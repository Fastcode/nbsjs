        ...
        public:
            z_stream_wrapper(bool _is_input, int _level, int _window_bits) : is_input(_is_input) {
                ...
                if (is_input) {
                    ...
                    ret = deflateInit2(this,
                                       _level,
                                       Z_DEFLATED,
                                       _window_bits ? _window_bits : 15 + 16,
                                       8,
                                       Z_DEFAULT_STRATEGY);
                }
                if (ret != Z_OK)
            ...
            if (this->gptr() == this->egptr()) {
                ...
                do {
                    ...
                    if (is_text) {
                        ...
                        if (!zstrm_p)
                            zstrm_p =
                                std::make_unique<detail::z_stream_wrapper>(true, Z_DEFAULT_COMPRESSION, window_bits);
