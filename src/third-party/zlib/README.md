The files in this folder were downloaded from the latest release of zlib from https://github.com/madler/zlib/releases (v1.3.1 at the time of writing), and modified as follows:
